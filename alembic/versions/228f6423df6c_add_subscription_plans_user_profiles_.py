...
def upgrade() -> None:
    """Upgrade schema."""
    # Create ENUM types explicitly first (required by asyncpg)
    payment_method_enum = sa.Enum(
        'credit_card', 'debit_card', 'deposit', 'transfer', 'cash', 'other',
        name='payment_method'
    )
    renewal_type_enum = sa.Enum('monthly', 'annual', name='renewal_type')
    payment_method_enum.create(op.get_bind(), checkfirst=True)
    renewal_type_enum.create(op.get_bind(), checkfirst=True)
    ...
    op.add_column('subscriptions', sa.Column('payment_method', payment_method_enum, nullable=True))
    op.add_column('subscriptions', sa.Column('renewal_type', renewal_type_enum, nullable=True))
...
def downgrade() -> None:
    ...
    # Drop ENUM types
    sa.Enum(name='renewal_type').drop(op.get_bind(), checkfirst=True)
